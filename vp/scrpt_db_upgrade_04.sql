...
INSERT INTO parameter_list (parameter_list_id, context, parameter_name, parameter_value, description) VALUES ('44', 'COMPANY_SETTING', 'DEPLETE_SOLD_STOCK_UPON', '1','0(Sales Invoice),1(Goods Delivery)');
