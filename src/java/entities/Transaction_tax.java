...
@ManagedBean
@SessionScoped
public class Transaction_tax implements Serializable {

    private static final long serialVersionUID = 1L;
    private long transaction_tax_id;
    ...
    /**
     * @return the transaction_tax_id
     */
    public long getTransaction_tax_id() {
        return transaction_tax_id;
    }

    /**
     * @param transaction_tax_id the transaction_tax_id to set
     */
    public void setTransaction_tax_id(long transaction_tax_id) {
