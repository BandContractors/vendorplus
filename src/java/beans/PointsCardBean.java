...
public class PointsCardBean implements Serializable {
    ...
    public void savePointsCard(PointsCard pointsCard) {
        ...
        if (pointsCard.getPointsCardId() == 0 && grb.IsUserGroupsFunctionAccessAllowed(aCurrentUserDetail,aCurrentGroupRights,"87", "Add")==0) {
            msg="YOU ARE NOT ALLOWED TO USE THIS FUNCTION, CONTACT SYSTEM ADMINISTRATOR...";
            FacesContext.getCurrentInstance().addMessage("Save", new FacesMessage(msg));
        }else if (pointsCard.getPointsCardId() > 0 && grb.IsUserGroupsFunctionAccessAllowed(aCurrentUserDetail,aCurrentGroupRights,"87", "Edit")==0) {
            msg="YOU ARE NOT ALLOWED TO USE THIS FUNCTION, CONTACT SYSTEM ADMINISTRATOR...";
            FacesContext.getCurrentInstance().addMessage("Save", new FacesMessage(msg));
        ...
        {     
            ...
            if (pointsCard.getPointsCardId() == 0) {
                ...
                cs.setDouble("in_points_balance", pointsCard.getPointsBalance());
    ...
    public PointsCard findPointsCard(long PointsCardId) {
        ...
        try (
            ...
            if (rs.next()) {
                ...
                pointsCard.setPointsBalance(rs.getDouble("points_balance"));
    ...
    public PointsCard getPointsCardByCardNumber(String PointsCardNumber) {
        ...
        try (
            ...
            System.err.println("getPointsCardByCardNumber:se:" + se.getMessage());
            return null;
        } catch(NullPointerException npe){
            System.err.println("getPointsCardByCardNumber:npe:" + npe.getMessage());
            FacesContext.getCurrentInstance().addMessage("Connection", new FacesMessage("Inter-Branch Database Connectivity is either LOST or PROBLEMATIC, contact admin...!"));
            return null;
        }finally {
            if (rs != null) {
    ...
    public void updatePointsCardBalance(String CardNumber, double Points) {
            String sql = null;
    ...
    public void addPointsCardBalanceByCardNo(String CardNumber, double Points) {
            String sql = null;
    ...
    public void addPointsCardBalanceByCardId(long CardId, double Points) {
            String sql = null;
    ...
    public void subtractPointsCardBalance(String CardNumber, double Points) {
            String sql = null;
