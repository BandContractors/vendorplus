...
public class AccJournalBean implements Serializable {
    ...
    public void postJournalCreditNote(long aCrNoteTransId, int aAccPeriodId, double aRefundAmount) {
        ...
        try {
            ...
            try {
                trans = new CreditDebitNoteBean().getTrans_cr_dr_note(aCrNoteTransId);
            } catch (Exception e) {
                //
            }
            try {
                transitems = new CreditDebitNoteBean().getTransItemsByTransactionId_cr_dr_note(aCrNoteTransId);
            } catch (Exception e) {
                //
            }
            //loyalty acc
