...
public class ReportStockBean implements Serializable {
    ...
    public ReportStock getReportStockFromResultset(ResultSet aResultSet) {
        try{
                ...
                try{
                    reportStock.setUnitRetailsalePrice(aResultSet.getDouble("unit_retailsale_price"));
                }catch(NullPointerException npe){
                    reportStock.setUnitRetailsalePrice(0);
                }
                try{
                    reportStock.setUnitWholesalePrice(aResultSet.getDouble("unit_wholesale_price"));
                }catch(NullPointerException npe){
                ...
                try{
                reportStock.setCurrentQty(aResultSet.getDouble("currentqty"));
                 }catch(NullPointerException npe){
    ...
    public ReportStock getReportStockTotalFromResultset(ResultSet aResultSet) {
        try{
                ...
                try{
                    reportStock.setCostValue(aResultSet.getDouble("cost_value"));
                 }catch(NullPointerException npe){
                    reportStock.setCostValue(0);
                }
                try{
                    reportStock.setRetailsaleValue(aResultSet.getDouble("retailsale_value"));
                 }catch(NullPointerException npe){
                    reportStock.setRetailsaleValue(0);
                }
                try{
                    reportStock.setWholesaleValue(aResultSet.getDouble("wholesale_value"));
                 }catch(NullPointerException npe){
    ...
    public ReportStockSummary getReportStockSummaryFromResultset(ResultSet aResultSet) {
        try{
            if(aResultSet!=null){
                ...
                try{
                    reportStockSummary.setSumCurrentQty(aResultSet.getDouble("sum_currentqty"));
                }catch(NullPointerException npe){
                    reportStockSummary.setSumCurrentQty(0);
                }
                try{
                    reportStockSummary.setSumCostValue(aResultSet.getDouble("sum_cost_value"));
                }catch(NullPointerException npe){
                    reportStockSummary.setSumCostValue(0);
                }
                try{
                    reportStockSummary.setSumWholesaleValue(aResultSet.getDouble("sum_wholesale_value"));
                }catch(NullPointerException npe){
                     reportStockSummary.setSumWholesaleValue(0);
                }
                try{
                    reportStockSummary.setSumRetailsaleValue(aResultSet.getDouble("sum_retailsale_value"));
                }catch(NullPointerException npe){
