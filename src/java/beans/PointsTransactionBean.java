...
public class PointsTransactionBean implements Serializable {
    ...
    public void savePointsTransaction(PointsTransaction pointsTransaction) {
        ...
        if (pointsTransaction.getPointsTransactionId() == 0 && grb.IsUserGroupsFunctionAccessAllowed(aCurrentUserDetail,aCurrentGroupRights,"88", "Add")==0) {
            msg="INTER BRANCH : YOU ARE NOT ALLOWED TO USE THIS FUNCTION, CONTACT SYSTEM ADMINISTRATOR...";
            FacesContext.getCurrentInstance().addMessage("Save", new FacesMessage(msg));
        }else if (pointsTransaction.getPointsTransactionId() > 0 && grb.IsUserGroupsFunctionAccessAllowed(aCurrentUserDetail,aCurrentGroupRights,"88", "Edit")==0) {
            msg="INTER BRANCH : YOU ARE NOT ALLOWED TO USE THIS FUNCTION, CONTACT SYSTEM ADMINISTRATOR...";
            FacesContext.getCurrentInstance().addMessage("Save", new FacesMessage(msg));
        ...
        {     
            ...
            if (pointsTransaction.getPointsTransactionId() == 0) {
                ...
                cs.setDouble("in_points_awarded", pointsTransaction.getPointsAwarded());
                cs.setDouble("in_points_spent", pointsTransaction.getPointsSpent());
                ...
                cs.setDouble("in_points_spent_amount", pointsTransaction.getPointsSpentAmount());
    ...
    public void addPointsTransactionToStage(PointsTransaction pointsTransaction) {
        ...
        {     
            ...
            System.err.println("addPointsTransactionToStage:se:" + se.getMessage());
        }catch(NullPointerException npe){
            System.err.println("addPointsTransactionToStage:npe:" + npe.getMessage());
    ...
    public void movePointsTransactionsFromStageToLive() {
        ...
        try (
            ...
            while (rs.next()) {
                ...
                pointsTransaction.setPointsAwarded(rs.getDouble("points_awarded"));
                pointsTransaction.setPointsSpent(rs.getDouble("points_spent"));
                ...
                pointsTransaction.setPointsSpentAmount(rs.getDouble("points_spent_amount"));
                this.addPointsTransactionToLive(pointsTransaction);
                this.deletePointsTransactionFromStage(pointsTransaction);
            }
        } catch (SQLException se) {
            System.err.println("movePointsTransactionsFromStageToLive:se:" + se.getMessage());
        } catch(NullPointerException npe){
            System.err.println("movePointsTransactionsFromStageToLive:npe:" + npe.getMessage());
    ...
    public void cancelPointsTransaction(PointsTransaction pointsTransaction) {
        ...
        {     
            ...
            try (
                ...
                cs.setDouble("in_points_awarded", pointsTransaction.getPointsAwarded()*(-1));
                cs.setDouble("in_points_spent", pointsTransaction.getPointsSpent()*(-1));
                cs.setLong("in_transaction_id", pointsTransaction.getTransactionId());
                cs.setInt("in_trans_branch_id", pointsTransaction.getTransBranchId());
                cs.setTimestamp("in_add_date", new java.sql.Timestamp(new java.util.Date().getTime()));
                cs.setString("in_add_user", new GeneralUserSetting().getCurrentUserNames());
                cs.setTimestamp("in_edit_date", new java.sql.Timestamp(new java.util.Date().getTime()));
                cs.setString("in_edit_user", new GeneralUserSetting().getCurrentUserNames());
                cs.setDouble("in_points_spent_amount", pointsTransaction.getPointsSpentAmount()*(-1));
