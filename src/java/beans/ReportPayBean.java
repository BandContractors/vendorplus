...
public class ReportPayBean implements Serializable {
    ...
    public ReportPay getReportPayFromResultset(ResultSet aResultSet) {
        try {
            ...
            reportPay.setPaidAmount(aResultSet.getDouble("paid_amount"));
            ...
            reportPay.setPointsSpent(aResultSet.getDouble("points_spent"));
            reportPay.setPointsSpentAmount(aResultSet.getDouble("points_spent_amount"));
    ...
    public ReportPaySummary getReportPaySummaryFromResultset(ResultSet aResultSet, String aFieldName) {
        try {
            if (aResultSet != null) {
                ...
                reportPaySummary.setSumPaidAmount(aResultSet.getDouble("sum_paid_amount"));
                reportPaySummary.setSumPointsSpentAmount(aResultSet.getDouble("sum_points_spent_amount"));
