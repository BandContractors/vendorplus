...
//    }
    ...
    public void reportSalesInvoiceDetail(Trans aTrans, TransBean aTransBean) {
        ...
        if (msg.length() > 0) {
            ...
            String sql = "SELECT *,'' as cr_dr_flag FROM transaction WHERE transaction_type_id IN(2,65,68)";
            String sqlsum = "";
            ...
            try (
                ...
                while (rs.next()) {
                    ...
                    trans.setCr_dr_flag(this.getTransCrDr(trans.getTransactionNumber()));
